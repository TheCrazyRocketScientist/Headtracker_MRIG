/* Comments and Additional Code Written By Paranjay Chaudhary. Based on the work done by Jeff Rowberg
 * 1. Implement Optimizations in the distant future
 * 
 * 
 */
#include "I2Cdev.h"
...
void setup() {
    ...
    .initialize sets the sensor to its most sensitive settings and wakes it from sleep mode.
     */
    pinMode(INTERRUPT_PIN, INPUT);
    // verify connection
    Serial.println(F("Testing device connections..."));
    Serial.println(mpu.testConnection() ? F("MPU6050 connection successful") : F("MPU6050 connection failed"));
     //.testconnection checks if the device is connected to the i2c bus by checking address 0x34
    // wait for ready
    /*
     * Routine to Empty DMP
     */
    ...
    //Dmp is switched off after this. Turn it on later.
